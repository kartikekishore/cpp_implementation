...
// vi g[N];
//=======================
//CodeChef Gotham City
//Using Multiset to store Pos,Availability
//First thought it was Fenwick Tree or Segment tree Question
//But Did this using MULTISET;
//https://www.codechef.com/SPYB21B
void sol()
{
    int n;
    cin >> n;
    ...
    while (q--)
    {
        ...
        while (it != mt.end())
        {
            if (it->second > k)
            {
                ...
                mt.insert({it->first, it->second - k});
                mt.erase(it);
                k -= k;
                break;
            }
