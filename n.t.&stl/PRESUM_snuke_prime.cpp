...
// vi g[N];
//=======================
//atcoder snuke prime presum question very good
...
void sol()
{
    ...
    int ans = 0, tmep = v[0].F, pref = v[0].S;
    for ( i = 1; i < v.size(); i++)
    {
        ...
        ans += ((min(c, pref )) * (curpos - tmep));
        //cout << curpos << " " << curcost << " " << ans << endl;
        pref += curcost;
        tmep = curpos;
    }
    cout << ans;
