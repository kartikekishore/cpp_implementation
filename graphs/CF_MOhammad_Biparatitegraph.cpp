...
// vi g[N];
//=======================
//MOhamaad & __- BIpartite grapgh codeforeces
std::vector<bool> visited(100000 + 1, false);
std::vector<int> color(100000 + 1);
std::vector<std::vector<int> > adj(100000 + 1);
...
void sol()
{
	int n;
	cin >> n;
	color.resize(n), visited.resize(n), adj.resize(n);
